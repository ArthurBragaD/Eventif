...
class ContactPostValid(TestCase):
    def setUp(self):
        data = dict(name="Arthur Braga", phone="53-91234-5678", email="Arthurbragadutra@gmail.com", message="Olá essa é a minha dúvida")
...
class ContactSuccessMessage(TestCase):
    def test_message(self):
        data = dict(name = "Arthur Braga", phone = '53-91234-5678',
                    email = 'Arthurbragadutra@gmail.com', message='Olá essa é a minha dúvida')
